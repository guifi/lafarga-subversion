...
#repo --name=base --baseurl=http://octocefal.guifi.net/yum/base/10-prepatched/x86_64/
#repo --name=base --baseurl=http://192.168.19.225/yum/base/10/x86_64/
#
#prepatched X68
#repo --name=base-prepatched --baseurl=http://10.138.0.8/yum/base/10-prepatched/x86_64/
#
#prepatched i68
#repo --name=base-prepatched --baseurl=http://10.138.0.8/yum/base/10-prepatched/i386/
repo --name=base-udl --baseurl=http://ftp.udl.es/pub/fedora/linux/releases/10/Everything/i386/os/
#
#
#repo --name=released --baseurl=http://192.168.19.225/yum/Everything/10/x86_64/
#repo --name=updates-udl --baseurl=http://ftp.udl.es/pub/fedora/linux/releases/10/updates/i386/os/
#mirrorlist=http://mirrors.fedoraproject.org/mirrorlist?repo=updates-released-f$releasever&arch=$basearch
#repo --name=updates --baseurl=http://192.168.19.225/yum/base/10-patched/x86_64/
...
#repo --name=updates386 --baseurl=http://ftp.rediris.es/pub/linux/distributions/fedora/updates/10/i386/
repo --name=updates386 --baseurl=http://ftp-stud.hs-esslingen.de/pub/fedora/linux/updates/10/i386/
# repo --name=base-guifi --baseurl=http://10.138.0.8/yum/base/10-guifi/
repo --name=base-guifi --baseurl=http://octocefal.guifi.net/yum/base/10-guifi/
...
# guifi.net
#mkdir /home/liveuser/Escriptori
#cp /usr/share/applications/liveinst.desktop /home/liveuser/Escriptori
#cp /usr/share/guifi-release/FederatedProxy.desktop /home/liveuser/Escriptori
#cp /usr/share/guifi-release/CNML.desktop /home/liveuser/Escriptori
#sed -i 's/Exec=\/usr\/bin\/liveinst/Exec=\/usr\/bin\/liveinst --kickstart=\/usr\/share\/guifi-release\/liveinst-guifi.cfg/' /usr/share/applications/liveinst.desktop
sed -i 's/Exec=\/usr\/bin\/liveinst/Exec=\/usr\/share\/guifi-release\/liveinst.pl/' /usr/share/applications/liveinst.desktop
sed -i 's/Terminal=false/Terminal=true/' /usr/share/applications/liveinst.desktop

<h4 id="method_link_add">guifi.link.add</h4>
<p><strong>Afegeix un nou enllaç entre dues interfícies de la xarxa.</strong></p>
<p>Aquest mètode només és vàlid entre interfícies del tipus <strong><em>Wan</em></strong>
...
<p>Segons les interfícies que s'introdueixin a aquest mètode, l'API
detecterà automàticament quin tipus d'enllaç nou crear.</p>

<h5 id="method_link_add_params">Paràmetres</h5>
...
<table>
	...
	<tbody>
		<tr class="required">
			...
			<td>integer</td>
			<td>Identificador de <a href="#method_device">dispositiu</a> des
			d'on fer l'enllaç.</td>
			<td></td>
		</tr>
		<tr class="required">
			<td>from_radiodev_counter</td>
			<td>integer</td>
			<td>Posició de la ràdio dins del dispositiu cap on fer l'enllaç.</td>
			<td></td>
		</tr>
		<tr class="required">
			<td>to_device_id</td>
			<td>integer</td>
			<td>Identificador de <a href="#method_device">dispositiu</a> cap on
			fer l'enllaç.</td>
			<td></td>
		</tr>
		<tr class="required">
...
<table>
	...
	<tbody>
		...
		<tr class="required">
			...
			<td>integer</td>
			<td>Identificador d'<a href="#method_interface">interfície</a> cap on
			fer l'enllaç.</td>
			<td></td>
		</tr>
		<tr>
...
<h5 id="method_link_add_return">Retorn</h5>
<p>A l'afegir un enllaç a un dispositiu de guifi.net, automàticament es
...
<table>
	...
	<tbody>
		<tr>
			<td>link_id</td>
			<td>integer</td>
			<td>Identificador del nou enllaç afegit</td>
		</tr>
		<tr class="group returngroup">
			<td>ipv4</td>
			<td>array</td>
			<td>Informació sobre la xarxa IPv4 que s'hagi afegit a la interfície.</td>
		</tr>
		<tr class="subgroup">
			<td colspan="3">
			<dl>

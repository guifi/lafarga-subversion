<h4 id="method_zone_add">guifi.zone.add</h4>
<p><strong>Afegeix una nova zona a la xarxa.</strong></p>

<h5 id="method_zone_add_params">Paràmetres</h5>
...
<table>
	...
	<tbody>
		<tr class="required">
			<td>title</td>
			<td>string</td>
			<td>Nom de la zona a crear.</td>
			<td></td>
		</tr>
		<tr>
			<td>nick</td>
			<td>string</td>
			<td>Abreviació de la zona a crear.</td>
		...
		<tr class="required">
			<td>master</td>
			<td>integer</td>
			<td>ID de la zona pare de la nova zona a crear.</td>
			<td></td>
		</tr>
		<tr>
			<td>time_zone</td>
			<td>integer</td>
			<td>Fus horari de la zona a crear.</td>
			<td><em>+01 2 2</em></td>
		</tr>
		<tr>
			<td>graph_server</td>
		...
		<tr>
			<td>ospf_zone</td>
			<td>string</td>
			<td>Identificador de zona OSPF de la zona a crear.</td>
			<td></td>
		</tr>
		<tr>
			<td>homepage</td>
			<td>string</td>
			<td>Adreça web relacionada amb la zona a crear.</td>
			<td></td>
		</tr>
		<tr>
			<td>notification</td>
...
<h5 id="method_zone_add_return">Retorn</h5>
